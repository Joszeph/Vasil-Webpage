...
const RightNavBar = (props) => {
  ...
  return (
    <Ul open={open}>
      ...
      <li className={router.pathname == "/" ? "active" : ""}><Link href="https://calendly.com/barbers_crew/app"><a target="_blank" onClick={() => setOpen(!open)}><div className="reservationBtn">{t.appointment}</div></a></Link></li>
    </Ul>
  )
}
